...
<head>
    ...
    <script type="text/javascript">
        var lang = {"problemConnecting":"There was a problem with connection", "validationFailed":"Input validation failed", "pictureName":"Picture name", "label":"Label"};
        ...
        <form autocomplete="off" class="insert-form" method="POST" action="/{{ app()->getLocale() }}/insert" enctype="multipart/form-data">
            <div class="left">
                ...
                <div id="labels">
                    ...
                    <div><a class="insert-label" onclick="add_label()" ><i class="fa fa-plus-circle" aria-hidden="true"></i> Add a label</a></div>
